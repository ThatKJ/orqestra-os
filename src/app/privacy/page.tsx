    ...
    <main className="pt-32 pb-20">
      <div className="max-w-[720px] mx-auto px-8">
        ...
        <div className="font-body text-[15px] text-text-mid leading-[1.8] space-y-4">
          <p><strong className="text-text-hi">Information We Collect.</strong> When you sign up for the Orquestra OS waitlist, we collect your email address and optionally your name, company, and use case. We also collect basic analytics via Plausible (anonymous page views, no cookies).</p>
          ...
          <p><strong className="text-text-hi">Retention.</strong> We retain your data until you request removal. Email us at orquestra.team@gmail.com to delete your information.</p>
